...
class TestGenerateSampleDataCommand:
    ...
    def test_generates_chapters(self, settings):
        ...
        assert PyladiesChapter.objects.filter(chapter_name="PyLadies San Francisco").exists()
    ...
    def test_generates_volunteer_profiles(self, settings):
        ...
        approved_profiles = VolunteerProfile.objects.filter(application_status="Approved")
        assert approved_profiles.count() >= 2
        
        # Check pending profile
        assert VolunteerProfile.objects.filter(application_status="Pending Review").exists()
    ...
    def test_generates_sponsorship_profiles(self, settings):
        ...
        assert SponsorshipProfile.objects.filter(organization_name="TechCorp International").exists()
        assert SponsorshipProfile.objects.filter(organization_name="PyTools Foundation").exists()
    ...
    def test_volunteer_profiles_have_relationships(self, settings):
        ...
        approved_profile = VolunteerProfile.objects.filter(application_status="Approved").first()
    ...
    def test_sponsorship_profiles_have_tiers(self, settings):
        ...
        sponsorship = SponsorshipProfile.objects.filter(organization_name="TechCorp International").first()
