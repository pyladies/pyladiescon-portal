...
class TestPortalIndex:
    ...
    def test_index_authenticated_with_volunteer_profile_and_teams(self, client, portal_user, django_assert_num_queries):
        ...
        portal_profile = PortalProfile(user=portal_user)
        portal_profile.save()
        volunteer_profile = VolunteerProfile.objects.create(user=portal_user, languages_spoken=["en"])
    ...
    def test_index_authenticated_with_volunteer_profile_no_teams(self, client, portal_user):
