...
class VolunteerProfile(BaseModel):
    ...
    def _validate_github_username(self):
        if self.github_username:
            if not re.match(r'^[a-zA-Z0-9](?:[a-zA-Z0-9]|-(?=[a-zA-Z0-9])){0,38}$', self.github_username):
    ...
    def _validate_discord_username(self):
        if self.discord_username:
            if not re.match(r'^[a-zA-Z0-9](?:[a-zA-Z0-9]|[._-](?=[a-zA-Z0-9])){0,30}[a-zA-Z0-9]$', self.discord_username):
    ...
    def _validate_bluesky_username(self):
        if self.bluesky_username:
            if not re.match(r'^[a-zA-Z0-9][a-zA-Z0-9.-]{0,28}[a-zA-Z0-9](\.[a-zA-Z0-9][\w.-]*\.[a-zA-Z]{2,})?$', self.bluesky_username):
                raise ValidationError(
    ...
    def _validate_mastodon_url(self):
        if self.mastodon_url:
            ...
            if not (re.match(mastodon_pattern1, self.mastodon_url) or re.match(mastodon_pattern2, self.mastodon_url)):
                raise ValidationError(
