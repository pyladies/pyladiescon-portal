    ...
    def test_valid_github_username(self):
        ...
        for username in valid_usernames:
            ...
            try:
                ...
                self.fail(
                    f"Valid GitHub username '{username}' raised ValidationError: {e}"
                )

    def test_invalid_github_username(self):
        invalid_usernames = ["-user123", "user123-", "user_123", "user 123", "a" * 40]
    ...
    def test_valid_discord_username(self):
        ...
        for username in valid_usernames:
            ...
            try:
                ...
                self.fail(
                    f"Valid Discord username '{username}' raised ValidationError: {e}"
                )
    ...
    def test_valid_instagram_username(self):
        ...
        for username in valid_usernames:
            ...
            try:
                ...
                self.fail(
                    f"Valid Instagram username '{username}' raised ValidationError: {e}"
                )
    ...
    def test_valid_bluesky_username(self):
        ...
        for username in valid_usernames:
            ...
            try:
                ...
                self.fail(
                    f"Valid Bluesky username '{username}' raised ValidationError: {e}"
                )
