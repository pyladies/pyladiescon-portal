...
class VolunteerProfileForm(ModelForm):
    ...
    def clean_discord_username(self):
        ...
        if discord_username:
            if not re.match(r'^[a-zA-Z0-9](?:[a-zA-Z0-9]|[._-](?=[a-zA-Z0-9])){0,30}[a-zA-Z0-9]$', discord_username):
    ...
    def clean_bluesky_username(self):
        ...
        if bluesky_username:
            ...
            if not re.match(r'^[a-zA-Z0-9][a-zA-Z0-9.-]{0,28}[a-zA-Z0-9](\.[a-zA-Z0-9][\w.-]*\.[a-zA-Z]{2,})?$', bluesky_username):
                raise ValidationError(
    ...
    def clean_mastodon_url(self):
        ...
        if mastodon_url:
            ...
            if not (re.match(mastodon_pattern1, mastodon_url) or re.match(mastodon_pattern2, mastodon_url)):
                raise ValidationError(
