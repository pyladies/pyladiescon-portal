...
Or if you using mac and your are getting the same error (consider checking cairo libraries on folder ```/opt/homebrew/lib```) if you dont't have any [try this](https://github.com/squidfunk/mkdocs-material/issues/5121)
